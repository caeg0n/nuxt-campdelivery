  ...
  <nav class="navigation">
    <ul>
      ...
      <li>
        ...
        <a class="arrow" href="pages-list.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
      ...
      <li>
        ...
        <a class="arrow" href="category-wide.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
      ...
      <li>
        ...
        <a class="arrow" href="order-history.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
      ...
      <li>
        ...
        <a class="arrow" href="wishlist.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
      ...
      <li>
        ...
        <a class="arrow" href="account.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
      ...
      <li>
        ...
        <a class="arrow" href="notification.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
      ...
      <li>
        ...
        <a class="arrow" href="setting.html"
          ><i data-feather="chevron-right"></i
        ></a>
      </li>
